...
void actualizar_posicion() {
  ...
  x_centro = x_centro + desplazamiento_x*(float)Math.pow(10,3);
  y_centro = y_centro + desplazamiento_y*(float)Math.pow(10,3);
}
...
void obtener_valores_acelerometro(String mediciones_accel_x[], String mediciones_accel_y[], String mediciones_accel_z[]) {
  ...
  if (calibrating == true) {
    ...
    if (first_reading_flag == 0) { //Primera lectura
      ...
      ax_previous = (float)calculate_acceleration(this.x_coefficients) - ax_off;
      ay_previous = (float)calculate_acceleration(this.y_coefficients) - ay_off;
      az_previous = (float)calculate_acceleration(this.z_coefficients) - az_off;
      ...
      ax = (float)calculate_acceleration(this.x_coefficients) - ax_off;
      ay = (float)calculate_acceleration(this.y_coefficients) - ay_off;
      az = (float)calculate_acceleration(this.z_coefficients) - az_off;
